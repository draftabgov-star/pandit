    ...
    <div className="relative mt-8 rounded-2xl overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 backdrop-blur-md">
        <div className="text-center p-6">
          <p className="text-amber-400 font-bold text-sm uppercase tracking-widest mb-2">🔒 Premium Locked</p>
          ...
          <button onClick={handleUnlock} className="bg-gradient-to-r from-amber-500 to-orange-500 text-black font-bold py-3 px-8 rounded-xl hover:scale-105 transition-transform">
            Unlock — $4.99
          </button>
        </div>
      </div>
